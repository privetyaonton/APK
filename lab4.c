...
void interrupt newTime(void);  // новый обработчик прерываний часов
void interrupt newAlarm(void); // новый обработчик прерываний будильника
void interrupt(*lastTime)(void); // старое прерывание часов
void interrupt(*lastAlarm) (void); // старое прерывание будильника
